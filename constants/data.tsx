import {
    ...
    Award,
    BarChart3,
    BellRing, CheckCircle2, Clock,
    Fingerprint, Laptop, Lightbulb,
...
export const features = [
    {
        ...
        description: "Get predictive analytics and actionable recommendations powered by advanced machine learning algorithms.",
        icon: Sparkles,
        gradient: "from-blue-600 to-blue-800"
    },
    {
        title: "Real-time Analytics",
        description: "Monitor your business performance with live dashboards and instant notifications for important events.",
        icon: BarChart3,
        gradient: "from-teal-600 to-teal-800"
    },
    {
        title: "Smart Automation",
        description: "Automate repetitive tasks and workflows with intelligent rules and triggers.",
        icon: Zap,
...
export const security = [
    ...
    },
    {
        ...
        description: "Multi-factor authentication with biometric security options",
        icon: Fingerprint,
        gradient: "from-purple-600 to-purple-800"
    },
    {
...
export const howitworks = [
        {
            ...
            description: "Seamlessly integrate with your existing financial tools and systems",
            icon: ArrowUpCircle,
            color: "blue"
        },
        {
